...
/*
   ...
   luhn(idNum)
     ...
     More Major Modifications by YOUR NAME
    -------------------------------------------------------------
...
window.addEventListener("load", function(){   
   ...
   var BRCformData = location.search.slice(1);
   BRCformData = BRCformData.replace(/\+/g," ");
   BRCformData = decodeURIComponent(BRCformData);
   var formFields = BRCformData.split(/[&=]/g);
