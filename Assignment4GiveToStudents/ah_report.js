...
var mydonationtotal = formatDollar(donationTotal)
/* Display the summary of total number of donors and total donations */
var summaryTable = "<table>";
summaryTable += "<tr><th>Donors</th><td>" + donors.length + "</td></tr>";
summaryTable += "<tr><th>Total Donations</th><td>" + mydonationtotal + "</td></tr>";
summaryTable += "</table>";

document.getElementById("donationSummary").innerHTML = summaryTable;

/* Donors who contributed $1000 or more */
var majorDonors = donors.filter(findMajorDonors);

/* Sort in descending order of donation $ */
...
/* Seperate table row for each donor */
